...
- Una Webcam estándar.
- **Node.js** o Python instalados en tu computadora (solo para eludir la restricción CORS de *localhost* requerida para utilizar captura de video).
...
- **Screenshake (`visualEffects.js`):** La fuerza en px para la traducción global del canvas. Por defecto salta a `30px` en *Expansión de Dominio*.
